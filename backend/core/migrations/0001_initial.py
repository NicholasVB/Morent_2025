# Generated by Django 4.2 on 2025-07-16 19:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=255, unique=True, verbose_name='URL')),
                ('main_photo', models.ImageField(upload_to=core.models.Car.upload_to_category_folder, verbose_name='Фото cо стороны')),
                ('inside_photo_one', models.ImageField(upload_to=core.models.Car.upload_to_category_folder, verbose_name='Первое фото внутри')),
                ('inside_photo_two', models.ImageField(upload_to=core.models.Car.upload_to_category_folder, verbose_name='Второе фото внутри')),
